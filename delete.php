...
<body>
    ...
    // on recupere les id de chaque menu afin de les cibler
    if(isset($_GET["IdDelete"])){
        $idDelete = $_GET["IdDelete"];
        echo "<h1>Suppresion du menu n°".$idDelete."</h1>";
        ?>
...
// requete qui permet de supprime le menu en fonction de son id
    $sql = ("DELETE FROM `menu` WHERE id = '".$idDelete."'");
    $RequeteStatement = $conn->query($sql);
